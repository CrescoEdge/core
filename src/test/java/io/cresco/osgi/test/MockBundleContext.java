...
public class MockBundleContext implements BundleContext
{
    ...
    {
        ServiceComponentRuntime serviceComponentRuntime = new MockServiceComponentRuntime();

        return (S)serviceComponentRuntime;
    }
    ...
    public ServiceReference<?>[] getServiceReferences( String arg0, String arg1 )
    {
        ...
        serviceReferences[0] = new MockServiceReference();
        return serviceReferences;
        //return EasyMock.createNiceMock(ServiceReference.class);
        //return sr;
    }
